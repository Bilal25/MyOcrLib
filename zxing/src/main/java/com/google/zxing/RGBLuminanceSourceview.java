 ...
 * @author Betaminos
 */
public final class RGBLuminanceSourceview extends LuminanceSourceview {
  ...
  public RGBLuminanceSourceview(int width, int height, int[] pixels) {
    super(width, height);
  ...
  private RGBLuminanceSourceview(byte[] pixels,
                                 int dataWidth,
                                 int dataHeight,
                                 int left,
                                 int top,
  ...
  public LuminanceSourceview crop(int left, int top, int width, int height) {
    return new RGBLuminanceSourceview(luminances,
                                  dataWidth,
                                  dataHeight,
                                  this.left + left,
                                  this.top + top,
