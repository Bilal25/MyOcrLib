 ...
 */
public final class EAN13Readerview extends UPCEANReaderview {
  ...
  BarcodeFormatview getBarcodeFormat() {
    return BarcodeFormatview.EAN_13;
  }
   ...
   *  encode digits
   * @throws NotFoundExceptionview if first digit cannot be determined
   */
