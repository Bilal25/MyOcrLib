...
/**
 * This object renders a CODE128 code as a {@link BitMatrixview}.
 *
 * @author erik.barbara@gmail.com (Erik Barbara)
 */
public final class Code128Writerview extends OneDimensionalCodeWriterview {
  ...
  public BitMatrixview encode(String contents,
    ...
    if (format != BarcodeFormatview.CODE_128) {
  ...
  public boolean[] encode(String contents) {
    ...
    while (position < length) {
      ...
      // Get the pattern
      patterns.add(Code128Readerview.CODE_PATTERNS[patternIndex]);
    ...
    checkSum %= 103;
    patterns.add(Code128Readerview.CODE_PATTERNS[checkSum]);

    // Append stop code
    patterns.add(Code128Readerview.CODE_PATTERNS[CODE_STOP]);
