 ...
 */
final class AI013X0X1XDecoderview extends AI01WeightDecoderview {
  ...
  AI013X0X1XDecoderview(BitArrayview information, String firstAIdigits, String dateCode) {
    super(information);
  ...
  @Override
  public String parseInformation() throws NotFoundExceptionview {
