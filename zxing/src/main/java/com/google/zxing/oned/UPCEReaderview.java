 ...
 * @author Sean Owen
 */
public final class UPCEReaderview extends UPCEANReaderview {
  ...
  public UPCEReaderview() {
    decodeMiddleCounters = new int[4];
  }

  @Override
  protected int decodeMiddle(BitArrayview row, int[] startRange, StringBuilder result)
  ...
  @Override
  protected int[] decodeEnd(BitArrayview row, int endStart) throws NotFoundExceptionview {
    return findGuardPattern(row, endStart, true, MIDDLE_END_PATTERN);
  }

  @Override
  protected boolean checkChecksum(String s) throws FormatExceptionview {
  ...
  BarcodeFormatview getBarcodeFormat() {
    return BarcodeFormatview.UPC_E;
  }
