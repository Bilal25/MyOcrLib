 ...
 */
public class DataCharacterview {

  private final int value;
  private final int checksumPortion;

  public DataCharacterview(int value, int checksumPortion) {
    this.value = value;
  ...
  public final boolean equals(Object o) {
    if (!(o instanceof DataCharacterview)) {
      return false;
    }
    DataCharacterview that = (DataCharacterview) o;
