...
/**
 * This object renders an EAN8 code as a {@link BitMatrixview}.
 *
 * @author aripollak@gmail.com (Ari Pollak)
 */
public final class EAN8Writerview extends UPCEANWriterview {
  ...
  public BitMatrixview encode(String contents,
    ...
    if (format != BarcodeFormatview.EAN_8) {
  ...
  public boolean[] encode(String contents) {
    ...
    for (int i = 0; i <= 3; i++) {
      ...
      pos += appendPattern(result, pos, UPCEANReaderview.L_PATTERNS[digit], false);
    }
