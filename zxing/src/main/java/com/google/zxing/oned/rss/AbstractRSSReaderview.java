...
import com.google.zxing.oned.OneDReaderview;

/**
 * Superclass of {@link OneDReaderview} implementations that read barcodes in the RSS family
 * of formats.
 */
public abstract class AbstractRSSReaderview extends OneDReaderview {
  ...
  protected AbstractRSSReaderview() {
  ...
  protected static int parseFinderValue(int[] counters,
                                        int[][] finderPatterns) throws NotFoundExceptionview {
   ...
   * @deprecated call {@link MathUtilsview#sum(int[])}
   */
  @Deprecated
  protected static int count(int[] array) {
    return MathUtilsview.sum(array);
  }
