 ...
 */
final class BitArrayBuilderview {

  private BitArrayBuilderview() {
  }

  static BitArrayview buildBitArray(List<ExpandedPairview> pairs) {
    ...
    BitArrayview binary = new BitArrayview(size);
    int accPos = 0;

    ExpandedPairview firstPair = pairs.get(0);
    ...
    for (int i = 1; i < pairs.size(); ++i) {
      ExpandedPairview currentPair = pairs.get(i);
