 ...
 * @author David Walker
 */
public final class CodaBarReaderview extends OneDReaderview {
  ...
  @Override
  public Resultview decodeRow(int rowNumber, BitArrayview row, Map<DecodeHintTypeview,?> hints) throws NotFoundExceptionview {
    ...
    if (hints == null || !hints.containsKey(DecodeHintTypeview.RETURN_CODABAR_START_END)) {
    ...
    return new Resultview(
        ...
        BarcodeFormatview.CODABAR);
  }

  private void validatePattern(int start) throws NotFoundExceptionview {
   ...
   */
  private void setCounters(BitArrayview row) throws NotFoundExceptionview {
    counterLength = 0;
  ...
  private int findStartPattern() throws NotFoundExceptionview {
