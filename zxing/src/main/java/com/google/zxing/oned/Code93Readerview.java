 ...
 *
 * @author Sean Owen
 * @see Code39Readerview
 */
public final class Code93Readerview extends OneDReaderview {
  ...
  public Resultview decodeRow(int rowNumber, BitArrayview row, Map<DecodeHintTypeview,?> hints)
    ...
    return new Resultview(
        ...
        BarcodeFormatview.CODE_93);

  }

  private int[] findAsteriskPattern(BitArrayview row) throws NotFoundExceptionview {
  ...
  private static void checkChecksums(CharSequence result) throws ChecksumExceptionvew {
