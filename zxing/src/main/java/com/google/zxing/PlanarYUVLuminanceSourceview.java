 ...
 */
public final class PlanarYUVLuminanceSourceview extends LuminanceSourceview {
  ...
  public PlanarYUVLuminanceSourceview(byte[] yuvData,
                                      int dataWidth,
                                      int dataHeight,
                                      int left,
                                      int top,
  ...
  public LuminanceSourceview crop(int left, int top, int width, int height) {
    return new PlanarYUVLuminanceSourceview(yuvData,
                                        dataWidth,
                                        dataHeight,
                                        this.left + left,
                                        this.top + top,
